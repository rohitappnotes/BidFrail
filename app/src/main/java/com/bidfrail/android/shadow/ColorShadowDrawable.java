package com.bidfrail.android.shadow;
...
//https://github.com/zhangjianliang110/color-shadow_drawable
public class ColorShadowDrawable extends Drawable {
     ...
     */
    public ColorShadowDrawable(Resources resources, ColorStateList backgroundColor, float radius, float shadowSize,
            float maxShadowSize) {
    ...
    private void setShadowSize(float shadowSize, float maxShadowSize) {
        ...
        mShadowSize = (int) (shadowSize * mShadowMultiplier + mInsetShadow + .5f);
        mDirty = true;
        invalidateSelf();
    }
    ...
    private void adaptDrawRoundRect(Canvas canvas, RectF bounds, float cornerRadius, Paint paint) {
        //if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            bounds.set(bounds.left + cornerRadius, bounds.top, bounds.right - cornerRadius, bounds.bottom);
    ...
    public float getMinHeight() {
        ...
        return content + (mRawMaxShadowSize * mShadowMultiplier + mInsetShadow) * 2;
    }
