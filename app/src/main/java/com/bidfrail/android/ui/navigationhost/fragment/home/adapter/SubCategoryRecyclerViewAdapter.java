...
public class SubCategoryRecyclerViewAdapter extends BaseSingleItemAdapter<SubCategory, BaseViewHolder> {

    private Context context;

    public SubCategoryRecyclerViewAdapter(Context context) {
        this.context = context;
        addChildClickViewIds(R.id.subCategoryRowItem);
    }

    @Override
    protected int getViewHolderLayoutResId() {
        return R.layout.sub_category_row_item;
    }
