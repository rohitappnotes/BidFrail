package com.bidfrail.android.ui.navigationhost.fragment.subservice.viewmodel;
...
public class SubServiceViewModel extends ViewModel {
    ...
    @Inject
    public SubServiceViewModel(LocalRepository localRepository, RemoteRepository remoteRepository) {
