package com.bidfrail.android.ui.navigationhost.fragment.getbids.viewmodel;
...
@HiltViewModel
public class GetBidsViewModel extends ViewModel {
    ...
    @Inject
    public GetBidsViewModel(LocalRepository localRepository, RemoteRepository remoteRepository) {
