...
public class ExceptionHelper {
    ...
    public NetworkException handleException(Throwable throwable){
        NetworkException remoteException = null;
        ...
        if(throwable instanceof UnknownHostException)
        {
            String displayMessage = "We can not find the server at "+ "RemoteConfiguration.HOST_URL"+" If that address is correct, here are three other things you can try :\n" +
                    ...
                    "3) If you are connected, Check that internet permission add in AndroidManifest.xml";
            remoteException = new NetworkException(throwable);
