package com.bidfrail.android.data.remote.exception;
 ...
 *
 * Server errors (500–599), the server failed to fulfil an apparently valid request
 */
public enum HttpStatusCode {
     ...
     * returned from {@code HttpStatusCode.valueOf(413)}
     */
    @Deprecated
     ...
     * @deprecated in favor of {@link #URI_TOO_LONG} which will be returned from {@code HttpStatusCode.valueOf(414)}
     */
    @Deprecated
    ...
    /**
     * Resolve the given status code to an {@code HttpStatusCode}, if possible.
     *
    ...
    public enum Series {
        ...
        /**
         * Return the {@code Series} enum constant for the supplied {@code HttpStatusCode}.
         *
         * @param status a standard HTTP status enum constant
         * @return the {@code Series} enum constant for the supplied {@code HttpStatusCode}
         * @deprecated as of 5.3, in favor of invoking {@link HttpStatusCode#series()} directly
         */
        @Deprecated
        ...
        /**
         * Resolve the given status code to an {@code HttpStatusCode.Series}, if possible.
         *
         * @param statusCode the HTTP status code (potentially non-standard)
